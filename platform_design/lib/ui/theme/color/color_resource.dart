...
class ColorResource {
  ...
  static const Color appBlack = Color(0xFF090b0e);
  static const Color subGrey = Color(0xFFADB1B6);
  static const Color textDimGrey = Color(0xFFA3ADBB);
  static const Color inputLineGrey = Color(0xFFB2BBC6);
